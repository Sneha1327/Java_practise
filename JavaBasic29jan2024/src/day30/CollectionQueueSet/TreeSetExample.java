package day30.CollectionQueueSet;
...
public class TreeSetExample {
	public static void main(String args[]) {
		...
		TreeSet<String> al = new TreeSet<String>();//hashset ignore duplicates
		//add will add the element in ascending order by ignoring duplicate elements
		al.add("Ravi");
		al.add("Vijay");
		al.add("Ravi");
		al.add("Ajay");

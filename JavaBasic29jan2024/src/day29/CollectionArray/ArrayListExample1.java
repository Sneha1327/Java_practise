...
public class ArrayListExample1 {
	public static void main(String args[]) {
		...
		list.add("Apple");
		list.add("Banana");
		list.add("123");// auto Boxing and Auto- upcasting to Object class object
		...
		System.out.println("Elements of list: " + list);
		// Sorting the list
		Collections.sort(list);// by default it sort the passed collection element in assending order and store
